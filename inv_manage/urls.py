...
from .views import InvListView, InvDetailView, InvCreateView, InvUpdateView, InvDeleteView, UserInvListView, ItemCreateView
from . import views
...
urlpatterns = [
    ...
    path('inv/<int:pk>/new_item/', ItemCreateView.as_view(), name='inv_manage-create-item'),
